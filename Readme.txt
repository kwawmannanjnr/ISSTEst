This project is for collecting the overhead of the satellite as per your location , 
It will collect the Latitude and  longitude of your current location from the device and send it to the server to get the data from ISS 
...
5: Tested all the edge cases as much as possible. 
6: Didn't get enough time to write unit test cases.
